  ...
  if (user.demos != 0) {
    return (
      <div className="user-demo-card w-fit relative inset-0 top-10">
        ...
        <Modal
          isOpen={showModal}
          className="bg-hero relative w-1/3 rounded-full flex flex-col ml-auto mr-auto border-2 pl-40 pr-4 mb-6 p-14 top-40"
        >
          <>
            <p className="relative text-center right-20 font-bold">
            ...
            <button
              className="relative top-10 right-20"
