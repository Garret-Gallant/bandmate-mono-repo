    ...
    <>
      {currentUser ? (
        <div className="relative mb-10">
          <div className="fixed top-0 pt-5 w-screen bg-gradient-to-b from-teal-700 to-transparent">
            ...
            <NavLink to="/demo-manager" className="nav-button">
              Demo Manager
            </NavLink>
            <NavLink to="/band-manager" className="nav-button">
              Band Manager
            </NavLink>
